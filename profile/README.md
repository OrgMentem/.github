...
Tools for trustworthy, provenance-aware research automation.

## What we're building

- ✍️ **inscribi** *(coming soon)* — A local-first feedback engine for marking student work. Extracts each submission, runs deterministic checks, then uses bounded, auditable AI evaluators to score against your rubric and draft comments. You review and own every grade; Inscribi writes feedback as annotated DOCX/PDFs.
